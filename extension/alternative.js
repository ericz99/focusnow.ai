...
class AlternativeWorkletProcessor extends AudioWorkletProcessor {
  ...
  constructor() {
    super();
    this.buffer = new Float32Array(AlternativeWorkletProcessor.BUFFER_SIZE);
    this.byteWritten = 0;
  }
  ...
  isBufferFull() {
    return this.byteWritten == AlternativeWorkletProcessor.BUFFER_SIZE;
  }
...
registerProcessor("alt-worklet-processor", AlternativeWorkletProcessor);
